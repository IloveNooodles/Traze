...
const satu = () => {
  return(
    <p>1. Tekan tombol camera yang terdapat di samping search bar<br></br> 2.aku sayang kamu <br></br> 3. aku sayang banget sama kamu :*
    </p>
  )
}
  ...
  return ( 
    <div className="helppage">
      ...
      <div className="container-help-body">
        {helps.map((help, i) => (
          <div className={"help " + (help.open ? 'open' : '')} key={i} onClick={() => toggleHelp(i)}>
